...
namespace CustomerProject.Controllers                              // came from the customer class
{
    public class CustomersController : Controller
    {
        private CustomerDbContext db = new CustomerDbContext();   // how you talk to entitiy framework everytime you create a controller you will create one db context then point to it from there on out
                                                                    
        // GET: Customers
        public ActionResult Index()                               // you get a method called index -list of all data from model 
